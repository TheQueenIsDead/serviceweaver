...
proto:
	...
	protoc --proto_path=api/ --go_out=internal/movie --go_opt=paths=source_relative --go-grpc_out=internal/movie --go-grpc_opt=paths=source_relative,require_unimplemented_servers=false movie.proto
	protoc --proto_path=api/ --go_out=internal/director --go_opt=paths=source_relative --go-grpc_out=internal/director --go-grpc_opt=paths=source_relative,require_unimplemented_servers=false director.proto
